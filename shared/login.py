...
the healer (brain), the crafters (forge), AND the harvester. Lives in shared/
so no app depends on another app's package (the healer used to import
forge.login — backwards; REFACTOR P0.7). Replaces the old
